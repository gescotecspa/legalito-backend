...
3. El backend busca la ultima version publicada.
4. El backend actualiza el usuario con esa referencia.
...
- se ignora el `user_id` forjado en la ruta
...
- dado un usuario autenticado y una version vigente publicada, cuando acepta terminos, entonces su registro queda asociado a la ultima version
